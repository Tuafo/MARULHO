...
At update 10,240, after 314,572,800 new positions or 31.25% of the schedule,
overall later loss reaches 2.842898. The 0.139966 total gain is 55.99% of the
terminal target, leaving 0.110034 unresolved. FineWeb-Edu, Cosmopedia, and DCLM
reach 3.051575/2.363457/3.113663, improvements of
0.106026/0.075348/0.238525 from the frozen start; DCLM reaches 119.26% of its
own required gain while both retained sources improve again. The latest
2,048-update interval adds 0.007451 overall gain, less than the prior 0.011285,
so the positive but diminishing slope still does not predict a terminal pass.
The 428,214,229-byte snapshot strict-reloads at SHA-256
`e4260d33...2044fba8`, rotates update 8,192 away, retains updates
9,216/10,240, and training advances through 10,272 at about 19.90k positions/s.

Update 11,264 writes and strict-reloads a 428,214,229-byte optimizer state at
SHA-256 `0bdfc777...4895145`. Model, optimizer, RNG, raw tensors, step counter,
schedule offset, and MARULHO ownership verify exactly with no external LLM.
Rotation deletes only update 9,216, retains updates 10,240/11,264, and training
advances through 11,296 at about 19.91k positions/s after 347,013,120 new
positions. This extends rollback evidence only; the sixth heldout curve remains
update 12,288.

At update 12,288, after 377,487,360 new positions or 37.5% of the schedule,
overall later loss reaches 2.834750. The 0.148115 total gain is 59.25% of the
terminal target, leaving 0.101885 unresolved. FineWeb-Edu, Cosmopedia, and DCLM
reach 3.043861/2.355865/3.104523, improvements of
0.113739/0.082939/0.247665 from the frozen start; DCLM reaches 123.83% of its
own requirement while both retained sources improve again. The latest interval
adds 0.008148 overall gain, modestly above the prior 0.007451 but still below
the update-8,192 interval. The 428,214,421-byte snapshot strict-reloads at
SHA-256 `35bee2c2...37bc22a`, rotates update 10,240 away, retains updates
11,264/12,288, and training advances through 12,320 at about 19.91k positions/s.

Update 13,312 writes and strict-reloads a 428,214,421-byte optimizer state at
SHA-256 `b704463b...e6f0d60`. Model, optimizer, RNG, raw tensors, counters,
schedule offset, ownership, and absent external LLM use all verify exactly.
Rotation deletes only update 11,264, retains updates 12,288/13,312, and training
advances through 13,344 at about 19.91k positions/s after 409,927,680 new
positions. This is rollback evidence only; the seventh heldout curve remains
update 14,336.

At update 14,336, after 440,401,920 new positions or 43.75% of the schedule,
overall later loss reaches 2.832335. The 0.150529 total gain is 60.21% of the
terminal target, leaving 0.099471 unresolved. FineWeb-Edu, Cosmopedia, and DCLM
reach 3.042442/2.354828/3.099735, total improvements of
0.115158/0.083977/0.252453; all still improve and DCLM reaches 126.23% of its
own requirement. The latest interval adds only 0.002415 overall gain, sharply
below the prior 0.008148. Passing now requires the remaining nine curve
intervals to average about 0.011052, 4.58 times the latest gain, so a terminal
pass looks unlikely but is not decided before the frozen schedule and cooldown.
The 428,214,677-byte snapshot strict-reloads at SHA-256
...
Update 17,408 writes and strict-reloads a 428,214,869-byte optimizer state at
SHA-256 `5ba42857...37ef13f`. Model, optimizer, RNG, raw tensors, counters,
schedule offset, ownership, and absent external LLM use all verify exactly.
Rotation deletes only update 15,360, retains updates 16,384/17,408, and training
advances through 17,536 after 538,705,920 new positions at about 19.96k
positions/s. This is rollback evidence only; update 18,432 remains the next
quality measurement.

At update 18,432, after 566,231,040 new positions or 56.25% of the schedule,
overall later loss reaches 2.822520. The 0.160344 total gain is 64.14% of the
terminal target, leaving 0.089656 unresolved. FineWeb-Edu, Cosmopedia, and DCLM
reach 3.031975/2.343819/3.091766, total improvements of
0.125626/0.094986/0.260422; every source improves and DCLM reaches 130.21% of
its own requirement. The latest interval adds 0.005011 overall gain. The
remaining seven intervals must average 0.012808 to pass, 2.56 times the latest
result. The 428,215,061-byte snapshot strict-reloads at SHA-256
`15ad169d...613ae9b`, rotates update 16,384 away, retains updates
17,408/18,432, and training advances through 18,528 at about 19.98k positions/s.

Update 19,456 writes and strict-reloads a 428,215,061-byte optimizer state at
SHA-256 `fc81c485...259ce10`. Model, optimizer, RNG, raw tensors, counters,
schedule offset, ownership, and absent external LLM use all verify exactly.
Rotation deletes only update 17,408, retains updates 18,432/19,456, and training
advances through 19,552 after 600,637,440 new positions at about 20.00k
