"""Multimodal dataset adapters for MARULHO (§5.4).
...
def events_to_frames(
    ...
    For MARULHO integration, these frames can be passed directly to
...
def iter_episode_steps(
    ...
    This is the primary integration point with the MARULHO trainer. Each step
