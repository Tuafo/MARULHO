"""Warm Companion bootstrap: distill teacher embeddings into MARULHO's positive manifold.
...
The key insight from the alignment study: MARULHO routing keys live on a
...
def project_to_nonneg_cone(
    ...
    """Project embeddings into MARULHO's nonneg L2-normalized cone.
    ...
    # L2 normalize (matching MARULHO's _normalize_positive_vector)
