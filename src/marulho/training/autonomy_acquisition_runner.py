...
def initialize_acquisition_trainer(
    ...
    warmup_rounds: int,
) -> tuple[MarulhoTrainer, list[SourceBank], list[dict[str, Any]]]:
    set_seed(seed)
...
def run_acquisition_benchmark(
    ...
    **kwargs: Any,
    ...
    if save_plots:
        from marulho.reporting.autonomy import plot_acquisition_summary
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run MARULHO autonomy acquisition benchmark across source banks")
