"""Dual sparsity utilities for MARULHO (§6.3).
...
- 2:4 structured sparsity: keep 2 largest-magnitude values in every group of 4.
  ...
  that.  In MARULHO this is used for offline weight compression and as a
...
class SparsityManager:
    ...
    Many MARULHO weight matrices carry invariants (positive-only values,
