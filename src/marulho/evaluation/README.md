...
- Current 2026-07-04 sampled-vocab CE Triton evidence in
  ...
  correctness set. The current seven-kernel suite snapshot is
  `language-suite-quality-replay-protective-selected-child-route-topk-controlled-aligned.json`,
  which includes route-top-k parity, same-checkpoint generation coherence, and
  524288-token sustained evidence while still keeping broad runtime promotion
  false.
