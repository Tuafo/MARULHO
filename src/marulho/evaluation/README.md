...
- `language_quality_replay_experiment.py` is the checkpoint-backed hard-prompt
  ...
  child checkpoint, then records same-child generation coherence and optional
  sustained runtime evidence. It is meant to move quality and speed evidence
  together without turning the benchmark suite into a gate-only workflow.
