...
def build_replay_training_plan(
    ...
    return {
        ...
        "proposed_train_command": (
            "python -m marulho.training.replay_adapter_experiment "
        ...
        "proposed_eval_command": (
            ...
            f"&& python -m marulho.evaluation.service_benchmark --output {eval_path} "
            f"&& python -m marulho.evaluation.replay_training_gate --input {bundle_path} --output {holdout_path}"
        ),
        "expected_cost_time": {
            "cost_usd": 0,
