"""MARULHO-owned spike-language neuron adapter evidence.
...
class SpikeLanguageNeuronAdapter:
    ...
    def evaluate(self, decoder_probe: Mapping[str, Any]) -> dict[str, Any]:
        ...
        return {
            "artifact_kind": "terminus_marulho_spike_language_neuron_adapter",
...
def evaluate_spike_language_trainer_dry_run(
    ...
    *,
    ...
    required = {
        ...
        "dry_run_owned_by_marulho": bool(report.get("owned_by_marulho")),
...
def generate_snn_language_readout_draft(
    ...
    *,
    ...
    evaluation_ready = (
        ...
        and bool(evaluation.get("owned_by_marulho"))
    ...
    ready = (
        ...
        and bool(report.get("owned_by_marulho"))
    ...
    return {
        ...
        "transition_memory_evaluation_evidence": {
            ...
            "owned_by_marulho": bool(evaluation.get("owned_by_marulho")),
        ...
        "promotion_gate": {
            ...
            "required_evidence": {
                "prediction_owned_by_marulho": bool(report.get("owned_by_marulho")),
...
def build_snn_language_readout_emission(
    ...
    required = {
        ...
        "draft_owned_by_marulho": bool(draft.get("owned_by_marulho")),
...
def rollout_snn_language_readout_candidate(
    ...
    *,
    ...
    """Roll MARULHO sparse transition memory forward into bounded grounded labels."""
    ...
    evaluation_ready = bool(
        evaluation.get("surface") == "snn_language_transition_memory_prediction_evaluation.v1"
        and evaluation.get("owned_by_marulho")
...
def evaluate_snn_language_readout_rollout_replay(
    ...
    *,
    ...
    required = {
        ...
        "candidate_owned_by_marulho": bool(candidate.get("owned_by_marulho")),
...
def build_spike_language_plasticity_pressure(
    ...
    *,
    ...
    required = {
        ...
        "mismatch_owned_by_marulho": bool(report.get("owned_by_marulho")),
        "external_dependency_absent": not bool(report.get("external_dependency")),
        "generation_absent": not bool(report.get("generates_text")),
        "runtime_training_absent": not bool(report.get("trains_runtime_model")),
        "runtime_mutation_absent": not bool(report.get("mutates_runtime_state")),
...
def run_spike_language_plasticity_trial(
    ...
    *,
    ...
    required = {
        ...
        "pressure_owned_by_marulho": bool(report.get("owned_by_marulho")),
...
def evaluate_spike_language_plasticity_replay(
    ...
    *,
    ...
    required = {
        ...
        "trial_owned_by_marulho": bool(report.get("owned_by_marulho")),
...
def run_spike_language_plasticity_replay_experiment(
    ...
    *,
    ...
    required = {
        ...
        "replay_evaluation_owned_by_marulho": bool(report.get("owned_by_marulho")),
...
def build_spike_language_plasticity_application_design(
    ...
    *,
    ...
    required = {
        ...
        "replay_experiment_owned_by_marulho": bool(report.get("owned_by_marulho")),
...
def evaluate_spike_language_plasticity_shadow_application(
    ...
    *,
    ...
    required = {
        ...
        "application_design_owned_by_marulho": bool(report.get("owned_by_marulho")),
...
def evaluate_spike_language_plasticity_live_application_readiness(
    ...
    *,
    ...
    required = {
        ...
        "shadow_application_owned_by_marulho": bool(report.get("owned_by_marulho")),
...
def evaluate_spike_language_plasticity_live_application_preflight(
    ...
    *,
    ...
    target_owned = bool(target.get("owned_by_marulho", True)) if target else False
    ...
    required = {
        ...
        "live_readiness_owned_by_marulho": bool(report.get("owned_by_marulho")),
        ...
        "application_target_owned_by_marulho": target_owned,
...
def build_snn_language_transition_memory_regeneration_proposal(
    ...
    *,
    ...
    replay_ready = (
        ...
        and bool(replay.get("owned_by_marulho"))
    ...
    return {
        ...
        "replay_evidence": {
            ...
            "owned_by_marulho": bool(replay.get("owned_by_marulho")),
