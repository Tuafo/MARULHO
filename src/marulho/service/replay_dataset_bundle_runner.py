...
from marulho.service.replay_dataset_bundle import (
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Export an operator-approved Terminus replay dataset bundle preview from a MARULHO checkpoint."
    )
...
def export_replay_dataset_bundle(
    ...
    *,
    ...
    metadata: dict[str, Any] = {
        ...
        "generated_by": "marulho.service.replay_dataset_bundle_runner",
...
def _write_json(payload: Mapping[str, Any], output: Path | None, *, indent: int, stdout: TextIO | None = None) -> None:
    ...
    write_json_report_with_readme(
        output,
        payload,
        title="Replay Dataset Bundle Preview",
        indent=indent,
    )
