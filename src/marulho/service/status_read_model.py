...
class StatusReadModel:
    ...
    trainer: The ``MarulhoTrainer`` instance (read-only access to model stats).
    ...
    def _runtime_truth_contract_locked(
        ...
        *,
        ...
        snn_language_readiness_gate = {
            ...
            "requires_marulho_owned_implementation": bool(
                (snn_language_surface.get("safety_invariants") or {}).get("requires_marulho_owned_implementation")
    ...
    def _column_runtime_evidence(
        ...
        *,
        ...
        return build_column_runtime_evidence(runtime_scope=runtime_scope)
    ...
    def _snn_language_dense_readout_resize_plan(
        ...
        required = {
            ...
            "capacity_pressure_owned_by_marulho": bool(pressure.get("owned_by_marulho")),
            "capacity_state_durable": bool(
    ...
    def _snn_language_capacity_boundary_inventory(
        *,
        ...
        inventory = [
            ...
            {
                "boundary_id": "runtime_facade.regeneration_permit_candidate_source_window",
                "owner": "runtime_facade",
            ...
            {
                "boundary_id": "runtime_facade.regeneration_application_preflight_candidate_source_window",
                "owner": "runtime_facade",
                "window_limit": SNN_LANGUAGE_APPLICATION_SYNAPSE_WINDOW_LIMIT,
                "window_policy": SNN_LANGUAGE_APPLICATION_SYNAPSE_WINDOW_POLICY,
                "requires_untruncated_source_payload": True,
            ...
            {
                "boundary_id": "runtime_facade.regeneration_application_candidate_source_window",
                "owner": "runtime_facade",
                "window_limit": SNN_LANGUAGE_APPLICATION_SYNAPSE_WINDOW_LIMIT,
                "window_policy": SNN_LANGUAGE_APPLICATION_SYNAPSE_WINDOW_POLICY,
                "requires_untruncated_source_payload": True,
    ...
    def _runtime_scope_report_locked(
        ...
        *,
        ...
        if callable(transition_reporter):
            runtime_scope["column_transition_runtime"] = deepcopy(
                transition_reporter()
            )
        ...
        *,
        ...
        def _snapshot() -> dict[str, Any]:
            ...
            required = {
                ...
                == "snn_language_neuron_capacity_expansion_design.v1",
                "design_owned_by_marulho": bool(design_artifact.get("owned_by_marulho")),
        ...
        *,
        ...
        def _snapshot() -> dict[str, Any]:
            ...
            required = {
                ...
                "plan_owned_by_marulho": bool(plan.get("owned_by_marulho")),
        ...
        *,
        ...
        def _snapshot() -> dict[str, Any]:
            ...
            layout_state_available = (
                ...
                and bool(dense_layout_state.get("owned_by_marulho"))
            )
        ...
        *,
        ...
        def _snapshot() -> dict[str, Any]:
            ...
            required = {
                ...
                "layout_migration_owned_by_marulho": bool(
                    migration_result.get("owned_by_marulho")
                ),
        ...
        *,
        ...
        def _snapshot() -> dict[str, Any]:
            ...
            required = {
                ...
                "tensor_integrity_owned_by_marulho": bool(integrity.get("owned_by_marulho")),
        ...
        *,
        ...
        def _snapshot() -> dict[str, Any]:
            ...
            required = {
                ...
                "training_owned_by_marulho": bool(training.get("owned_by_marulho")),
        ...
        *,
        ...
        def _snapshot() -> dict[str, Any]:
            ...
            required = {
                ...
                "decoder_probe_owned_by_marulho": bool(probe.get("owned_by_marulho")),
