...
update throughput, standalone continual speed-sweep selection,
forgetting/replay metrics, installed-brain structural plasticity, checkpoint
lineage, 524288-token house-scale sustained runs, active compute, GPU-kernel,
