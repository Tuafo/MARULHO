...
from marulho.semantics.grounding_text import match_terms, salient_query_terms
...
from marulho.service.delayed_consequence import DELAYED_CONSEQUENCE_STATE_FIELDS, DelayedConsequenceDependencies, DelayedConsequenceTracker
...
from marulho.service.runtime_control import RUNTIME_CONTROL_STATE_FIELDS, RuntimeControl
...
from marulho.service.terminus_autonomy import TerminusAutonomyCore
...
from marulho.service.terminus_autonomy import _canonical_provider_term  # noqa: E402
...
def _install_state_property(
    ...
    if name in MarulhoServiceManager.__dict__:
        return

    def _get(self: MarulhoServiceManager) -> Any:
        module = object.__getattribute__(self, module_attr)
        return getattr(module, name)

    def _set(self: MarulhoServiceManager, value: Any) -> None:
        module = object.__getattribute__(self, module_attr)
        setattr(module, name, value)

    setattr(MarulhoServiceManager, name, property(_get, _set))
