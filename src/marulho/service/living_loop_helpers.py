...
def _verification_status_from_payload(value: Any) -> VerificationStatus:
    ...
    from marulho.service.living_loop_records import VerificationStatus  # lazy: avoids circular import
...
def _coerce_world_model_lite(value: WorldModelLiteSummary | Mapping[str, Any] | None) -> WorldModelLiteSummary:
    ...
    from marulho.service.living_loop_policy import WorldModelLiteSummary  # lazy: avoids circular import
