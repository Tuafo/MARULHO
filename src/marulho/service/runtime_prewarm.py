...
from marulho.data.corpus_loader import load_hf_first_rows
...
class RuntimePrewarmer:
    ...
    def _start_remote_warm_promotion_locked(self, *, trigger: str) -> bool:
        ...
        thread = Thread(target=self._remote_warm_promotion_loop, name="marulho-remote-warm-promotion", daemon=True)
    ...
    def _run_budgeted_call(func: Any, /, *args: Any, wait_seconds: float | None = None, **kwargs: Any) -> tuple[bool, Any]:
        ...
        Thread(target=_runner, name="marulho-budgeted-call", daemon=True).start()
        try:
    ...
    def _start_ingestion_prewarm_locked(self, *, trigger: str) -> bool:
        ...
        thread = Thread(target=self._ingestion_prewarm_loop, name="marulho-ingestion-prewarm", daemon=True)
