...
class HECSNServiceManager(
    ...
    def _build_interaction_pipeline(self) -> InteractionPipeline:
        return InteractionPipeline(
            ...
            observe_runtime_concepts_fn=self._observe_runtime_concepts_locked,
            runtime_state_mark_mutated_fn=self._runtime_state.mark_mutated,
            runtime_state_mutation_summary_fn=self._runtime_state.mutation_summary,
            ...
            runtime_episode_trace_fn=self._runtime_episode_trace_locked,
            replace_runtime_episode_trace_fn=self._replace_runtime_episode_trace_locked,
