        ...
        payload = {
            ...
            "training_gate": {
                ...
                "required_before_training": [
                    "versioned_dataset_manifest",
                    "dedupe_complete",
                    "train_holdout_eval_split",
                    "decontamination_check",
                    "offline_regression_benchmark",
                    "explicit_operator_training_approval",
                ],
                "satisfied_conditions": {
                    "versioned_dataset_manifest": True,
                    "dedupe_complete": True,
                    "train_holdout_eval_split": True,
                    "decontamination_check": True,
                    "operator_packaging_approval": True,
                    "offline_regression_benchmark": False,
