...
The sixth authoritative curve at update 12,288 covers 377,487,360 new
positions, or 37.5% of the schedule. Overall later loss reaches 2.834750,
improving by 0.008148 since update 10,240 and by 0.148115 from the frozen start.
That is 59.25% of the terminal target with 0.101885 unresolved. FineWeb-Edu,
Cosmopedia, and DCLM reach 3.043861/2.355865/3.104523, total gains of
0.113739/0.082939/0.247665. DCLM reaches 123.83% of its own requirement while
both retained sources improve again. The interval slope modestly rebounds from
0.007451 but remains below the update-8,192 interval. The 428,214,421-byte
optimizer snapshot strict-reloads at SHA-256 `35bee2c2...37bc22a`, rotates
update 10,240 away, retains exactly 11,264/12,288, and training advances through
12,320 at about 19.91k positions/s.

Update 13,312 writes and strict-reloads a 428,214,421-byte optimizer snapshot
at SHA-256 `b704463b...e6f0d60`. Exact verification covers model, optimizer,
RNG, raw tensors, counters, schedule offset, ownership, and absent external LLM
use. Rotation deletes only update 11,264, retains exactly 12,288/13,312, and
training advances through 13,344 after 409,927,680 new positions at about
...
Update 17,408 writes and strict-reloads a 428,214,869-byte optimizer snapshot
at SHA-256 `5ba42857...37ef13f`. Exact verification covers model, optimizer,
RNG, raw tensors, counters, schedule offset, ownership, and absent external LLM
use. Rotation deletes only update 15,360, retains exactly 16,384/17,408, and
training advances through 17,536 after 538,705,920 new positions at about
19.96k positions/s. This adds rollback evidence only; update 18,432 remains the
next quality measurement.

The ninth authoritative curve at update 18,432 covers 566,231,040 new
positions, or 56.25% of the schedule. Overall later loss reaches 2.822520,
improving by 0.005011 since update 16,384 and by 0.160344 from the frozen start.
That is 64.14% of the terminal target with 0.089656 unresolved. FineWeb-Edu,
Cosmopedia, and DCLM reach 3.031975/2.343819/3.091766, total gains of
0.125626/0.094986/0.260422; every source improves and DCLM reaches 130.21% of
its own requirement. The remaining seven curve intervals must average 0.012808
to pass, 2.56 times the latest 0.005011 result. The 428,215,061-byte optimizer
snapshot strict-reloads at SHA-256 `15ad169d...613ae9b`, rotates update 16,384
away, retains exactly 17,408/18,432, and training advances through 18,528 at
about 19.98k positions/s.

Update 19,456 writes and strict-reloads a 428,215,061-byte optimizer snapshot
at SHA-256 `fc81c485...259ce10`. Exact verification covers model, optimizer,
RNG, raw tensors, counters, schedule offset, ownership, and absent external LLM
use. Rotation deletes only update 17,408, retains exactly 18,432/19,456, and
training advances through 19,552 after 600,637,440 new positions at about
