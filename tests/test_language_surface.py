            ...
            },
            {
                ...
                "cuda_first_runtime": {
                    ...
                    "subcortex_tensor_devices": {
                        "competitive": {"prototype_device": "cuda:0"},
                        "predictive": {"location_state_device": "cuda:0"},
                    },
                }
            },
        )
...
class SubcorticalSelfRepairSurfaceTests(unittest.TestCase):
    def test_silent_spike_health_yields_repair_review_candidate(self) -> None:
        ...
        self.assertEqual(surface["promotion_gate"]["next_gate"], "deep_sleep_or_replay_repair_gate")
