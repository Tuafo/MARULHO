...
from marulho.service.snn_language_readout_ledger import (
    ...
    readout_replay_payload_window_bounded,
    rollout_regeneration_candidate_window_bounded,
)
...
def test_readout_ledger_source_window_validators_require_explicit_flags() -> None:
    ...
    assert rollout_regeneration_candidate_window_bounded(
        rollout_window,
        surface=rollout_surface,
    ) is True
    ...
    assert readout_replay_payload_window_bounded(
        readout_window,
        surface=readout_surface,
    ) is True
