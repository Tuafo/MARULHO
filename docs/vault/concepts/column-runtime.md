...
The registry, scheduler, voting, growth, and pruning model remains primarily report-only. `core.column_runtime` reads existing predictive-column and competitive-column tensors, then reports:
